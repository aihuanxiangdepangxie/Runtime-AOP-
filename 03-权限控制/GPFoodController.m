...
#import "GPFoodDetailController.h"

@interface GPFoodController ()

@end

@implementation GPFoodController
...
- (void)btnTouch:(UIButton *)btn
{
    ...
    */
    ...
    GPFoodDetailController * detailController = [[GPFoodDetailController alloc] init];
