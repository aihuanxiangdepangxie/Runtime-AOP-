...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    GPHomeController * home = [[GPHomeController alloc] init];
    UINavigationController * navHome = [[UINavigationController alloc] initWithRootViewController:home];
    navHome.title = @"首页";
    navHome.view.backgroundColor = [UIColor yellowColor];
    
    GPFoodController * food = [[GPFoodController alloc] init];
    UINavigationController * navFood = [[UINavigationController alloc] initWithRootViewController:food];
    navFood.title = @"美食";
    navFood.view.backgroundColor = [UIColor redColor];
    ...
    navMine.title = @"我的";
    navMine.view.backgroundColor = [UIColor greenColor];
